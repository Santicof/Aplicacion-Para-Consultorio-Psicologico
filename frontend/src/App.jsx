              ...
              <div className="logo-section">
                <div className="logo-circle">
                  <svg viewBox="0 0 100 100" className="logo-icon">
                    <circle cx="35" cy="35" r="25" fill="none" stroke="currentColor" strokeWidth="2"/>
                    <path d="M 60 50 Q 80 50 80 70" fill="none" stroke="currentColor" strokeWidth="2"/>
        ...
        <footer className="footer">
          <div className="container">
            <div className="footer-content">
              ...
              <div className="footer-section">
                ...
                <ul className="footer-list">
                  <li>Psicología Clínica Infantil</li>
                  <li>Psicología Clínica de Adultos</li>
            ...
            <div className="footer-bottom">
              <p>© 2026 Consultorio Integral Psique - Todos los derechos reservados</p>
            </div>
          </div>
        </footer>
      </div>
